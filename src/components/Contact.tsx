  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        ...
        description: 'We could not send your message. Please try again in a moment.',
        variant: 'destructive',
      });
    }
  };
    ...
    <section id="contact" ref={sectionRef} className="relative min-h-screen bg-deep-black px-6 py-24 md:px-12">
      <div className="mx-auto max-w-4xl">
        ...
        <div className="mb-16 text-center">
          ...
          <div className="mb-6 flex items-baseline justify-center gap-2 md:gap-6">
            <h2 className="font-display text-3xl font-bold text-primary whitespace-nowrap md:text-6xl">
              Connect with
            </h2>
            <img 
              src={lohamLogo} 
              alt="Loham" 
              className="h-10 w-auto -mt-1 animate-fade-in md:h-20 md:-mt-2"
            />
          </div>
